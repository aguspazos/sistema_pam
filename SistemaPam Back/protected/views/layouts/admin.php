...
<body class="font1">	
    ...
    <div id="adminContainer">
                ...
                <div class="menuSection">
                    <div class="menuTitleBar">
                        ...
                        <div class="menuTitleBarContainer">
                            ...
                            <a href="/Users/export" target="_blank">
                                <div class="menuTitleText">Usuarios</div>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div id="contentContainer" class="backgroundColor4">
            ...
            <div id="contentFooter" class="backgroundColor1 color1">
                <div id="poweredBy">
            ...
            <div id="alertMessageDivContainer">
                ...
                <div id="alertMessageDiv">
                    <div id="alertMessageLogoDiv">
                        <img id="alertMessageLogo" src="/files/layouts/havanaLogo.png"/>
                    </div>
