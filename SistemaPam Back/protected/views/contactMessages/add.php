...
<div class='adminTitle'>Agregar <?php echo(ContactMessages::getModelName('singular'));?></div>
<div class='adminSubtitle'>Completá los datos para agregar un nuevo <?php echo(ContactMessages::getModelName('plural'));?></div>
