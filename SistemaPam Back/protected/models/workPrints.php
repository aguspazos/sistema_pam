...
/**
 * This is the model class for table "work_prints".
 *
 * The followings are the available columns in table 'work_prints':
 * @property integer $id
...
class WorkPrints extends CActiveRecord{
    
        
        
        public static function getModelName($type){
            switch($type){
                case 'plural': return 'WorkPrinted';
                case 'singular': return 'WorkPrinted';
                case 'pluralCamelCase': return 'WorkPrinted';
                case 'singularCamelCase': return 'WorkPrinted';
                default: return '';
            }
        }
