<?php
	...
	public function actionAdd()
	{
		...
		try
		{
                        if(isset(_POST['email']) && isset(_POST['name']) && isset(_POST['last_name']) && isset(_POST['phone']) && isset(_POST['administrator_role_id']) && isset(_POST['active'])){
                            if(Administrators::checkUnique(_POST['email'])){
                                    $administrator = Administrators::create(_POST['email'],_POST['name'],_POST['last_name'],_POST['phone'],_POST['administrator_role_id'],_POST['active']);
