...
include(__DIR__.'/services/s3.class.php');
include(__DIR__.'/utilities/utilities.class.php');
include(__DIR__.'/utilities/credentials.class.php');
include(__DIR__.'/utilities/credential.class.php');
include(__DIR__.'/lib/requestcore/requestcore.class.php');
include(__DIR__.'/utilities/request.class.php');
include(__DIR__.'/utilities/response.class.php');
